...
• Les [b]serious games d'entraînement[/b] : l'objectif est d'améliorer les capacités cognitives ou motrices des utilisateurs par l'entraînement, la répétition. C'est le cas de America's Army, le jeu de tir.

• Les [b]serious games de simulation ou serious play[/b] : l'objectif est d'évaluer les utilisateurs en ne donnant pas d'objectif final précis ou en laissant l'utilisateur libre de ces choix avec des interactions plus libres. Ces applications offrent un panel ouvert d'usages comme l'entraînement ou la sensibilisation à un message.